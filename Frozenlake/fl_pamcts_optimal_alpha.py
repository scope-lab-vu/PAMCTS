...
def test_pamcts(args):
    try:
        ...
        if not os.path.exists("frozenlake_reorder_pamcts_optimal_alpha.csv"):
            with open("frozenlake_reorder_pamcts_optimal_alpha.csv", "w") as f:
            ...
            with open("frozenlake_reorder_pamcts_optimal_alpha.csv", "a") as f:
...
if __name__ == "__main__":
    args = []
    alpha_list = [1.0, 0.9, 0.9, 1.0, 1.0, 1.0, 1.0, 0.2]
    alpha_index = 0
