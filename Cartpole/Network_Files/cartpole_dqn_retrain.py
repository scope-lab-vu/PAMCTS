...
# Ctrl + C.
dqn.load_weights("duel_dqn_CartPole-v1_weights_2500.h5f")
dqn.fit(env, nb_steps=100000, visualize=False, verbose=2)

# After training is done, we save the final weights.
dqn.save_weights(f'duel_dqn_{ENV_NAME}_weights_2500_retrain.h5f', overwrite=True)
...
# write to file
with open('duel_dqn_CartPole-v1_weights_2500_retrain.txt', 'w') as f:
    f.write('retrain computation time: {}\n'.format(end_time - start_time))
