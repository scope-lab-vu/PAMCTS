...
if __name__ == "__main__":
    num_cpus = 90
    saved_file_name = "frozenlake_optimal_alpha_final.csv"
    # saved_file_name = "sanity_check2.csv"
    begin_time = time.time()
    args = []
    alpha_list = [1.0, 0.3, 0.65, 0.95, 0.85, 0.75, 0.45, 0.10]
    alpha_index = 0
    ...
    with open("frozenlake_optimal_alpha_execution_time_final.txt", "w") as f:
        f.write(f"fl final optimal alpha experiments execution time: {time.time() - begin_time}")
