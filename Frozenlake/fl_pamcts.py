...
def test_pamcts(args):
    try:
        ...
        if not os.path.exists("frozenlake_pamcts_results_reorder.csv"):
            with open("frozenlake_pamcts_results_reorder.csv", "w") as f:
            ...
            with open("frozenlake_pamcts_results_reorder.csv", "a") as f:
