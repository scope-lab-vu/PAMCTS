...
def test_pamcts(args):
    try:
        ...
        if not os.path.exists("frozenlake_reorder_alpha_selection_part2.csv"):
            with open("frozenlake_reorder_alpha_selection_part2.csv", "w") as f:
            ...
            with open("frozenlake_reorder_alpha_selection_part2.csv", "a") as f:
...
if __name__ == "__main__":
    args = []
    for prob_distribution in [[5.0 / 6.0, 1.0 / 12.0, 1.0 / 12.0], [11.0 / 15.0, 2.0 / 15.0, 2.0 / 15.0],
