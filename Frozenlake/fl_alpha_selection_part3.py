...
def test_pamcts(args):
    try:
        ...
        if not os.path.exists("frozenlake_reorder_alpha_selection_part3.csv"):
            with open("frozenlake_reorder_alpha_selection_part3.csv", "w") as f:
            ...
            with open("frozenlake_reorder_alpha_selection_part3.csv", "a") as f:
...
if __name__ == "__main__":
    args = []
    for prob_distribution in [[8.0 / 15.0, 7.0 / 30.0, 7.0 / 30.0],
