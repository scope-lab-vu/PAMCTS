...
def test_pamcts(args):
    try:
        ...
        if not os.path.exists("frozenlake_reorder_alpha_selection.csv"):
            with open("frozenlake_reorder_alpha_selection.csv", "w") as f:
            ...
            with open("frozenlake_reorder_alpha_selection.csv", "a") as f:
